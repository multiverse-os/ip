...
// centralized configuration file in Go
...
// TODO: make this function more generic and just pass in the service that needs
// caching to it
func CacheMaxmind(cfg Config, rt *Runtime) {
	defer rt.wg.Done()
